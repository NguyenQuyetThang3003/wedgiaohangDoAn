...
using WedNightFury.Models.VnPay;   // ĐÚNG: trỏ tới namespace chứa PaymentResponseModel

namespace WedNightFury.Libraries      // ĐÚNG: WedNightFury, không phải WedNightFur
{
    public class VnPayLibrary
    {
        ...
        {
            var rspRaw = GetResponseDataWithoutHash();
        ...
        private string GetResponseDataWithoutHash()
        {
            var data = new StringBuilder();
